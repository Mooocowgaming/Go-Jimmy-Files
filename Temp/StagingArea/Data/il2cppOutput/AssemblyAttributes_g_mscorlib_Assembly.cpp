...
void g_mscorlib_Assembly_CustomAttributesCacheGenerator(CustomAttributesCache* cache)
{
	cache->attributes = (Il2CppObject**)il2cpp_gc_alloc_fixed(sizeof(t25 *) * cache->count, 0);
	{
		...
		m2525(tmp, il2cpp_codegen_string_new_wrapper("MONO Common language infrastructure"), &m2525_MI);
	...
	}
	{
		...
		m3584(tmp, il2cpp_codegen_string_new_wrapper("../silverlight.pub"), &m3584_MI);
		cache->attributes[2] = (Il2CppObject*)tmp;
	}
	{
		t1100 * tmp;
		tmp = (t1100 *)il2cpp_codegen_object_new (&t1100_TI);
		m5859(tmp, &m5859_MI);
		cache->attributes[3] = (Il2CppObject*)tmp;
	}
	{
		t1097 * tmp;
		tmp = (t1097 *)il2cpp_codegen_object_new (&t1097_TI);
		m5858(tmp, 1, &m5858_MI);
	...
	{
		t1117 * tmp;
		tmp = (t1117 *)il2cpp_codegen_object_new (&t1117_TI);
		m5891(tmp, 2, 0, &m5891_MI);
	...
	{
		t790 * tmp;
		tmp = (t790 *)il2cpp_codegen_object_new (&t790_TI);
		m3583(tmp, 8, &m3583_MI);
	...
	}
	{
		...
		m2526(tmp, il2cpp_codegen_string_new_wrapper("3.0.40818.0"), &m2526_MI);
		cache->attributes[10] = (Il2CppObject*)tmp;
	}
	{
		t543 * tmp;
		tmp = (t543 *)il2cpp_codegen_object_new (&t543_TI);
		m2530(tmp, il2cpp_codegen_string_new_wrapper("(c) various MONO Authors"), &m2530_MI);
		cache->attributes[11] = (Il2CppObject*)tmp;
	}
	{
		t793 * tmp;
		tmp = (t793 *)il2cpp_codegen_object_new (&t793_TI);
		m3586(tmp, il2cpp_codegen_string_new_wrapper("mscorlib.dll"), &m3586_MI);
		cache->attributes[12] = (Il2CppObject*)tmp;
	}
	{
		t534 * tmp;
		tmp = (t534 *)il2cpp_codegen_object_new (&t534_TI);
		m2521(tmp, il2cpp_codegen_string_new_wrapper("mscorlib.dll"), &m2521_MI);
		cache->attributes[13] = (Il2CppObject*)tmp;
	}
	{
		t535 * tmp;
		tmp = (t535 *)il2cpp_codegen_object_new (&t535_TI);
		m2522(tmp, il2cpp_codegen_string_new_wrapper("mscorlib.dll"), &m2522_MI);
		cache->attributes[14] = (Il2CppObject*)tmp;
	}
	{
		t540 * tmp;
		tmp = (t540 *)il2cpp_codegen_object_new (&t540_TI);
		m2527(tmp, il2cpp_codegen_string_new_wrapper("BED7F4EA-1A96-11D2-8F08-00A0C9A6186D"), &m2527_MI);
	...
	{
		t787 * tmp;
		tmp = (t787 *)il2cpp_codegen_object_new (&t787_TI);
		m3580(tmp, il2cpp_codegen_string_new_wrapper("3.0.40818.0"), &m3580_MI);
		cache->attributes[19] = (Il2CppObject*)tmp;
	}
	{
		t786 * tmp;
		tmp = (t786 *)il2cpp_codegen_object_new (&t786_TI);
		m3579(tmp, il2cpp_codegen_string_new_wrapper("2.0.5.0"), &m3579_MI);
